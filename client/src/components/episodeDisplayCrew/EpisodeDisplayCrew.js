...
function EpisodeDisplayCrew({ crew }) {
    ...
    return(
        <div className="episode-display-crew-container">
            <Container className="crew-carousel-col">
                <Row>
                    <Col>
                        <div className="episode-crew-display-title">
                            <h1>Crew & Staff</h1>
                        </div>
                    </Col>
                </Row>
...
export default EpisodeDisplayCrew;