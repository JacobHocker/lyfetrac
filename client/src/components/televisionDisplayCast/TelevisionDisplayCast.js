...
function TelevisionDisplayCast({ cast }){
    ...
    return(
        <div className="television-display-cast-container">
            <Container className="cast-carousel-col">
                <Row>
                    <Col>
                        <div className="tv-cast-display-title">
...
export default TelevisionDisplayCast;